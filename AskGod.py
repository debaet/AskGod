...
def main():
    ...
    while True:
        ...
        elif any(keyword in var for keyword in sayingok):
            print(end='God Says... ')
            print(random.choice(g4))
        
        elif any(keyword in var for keyword in sayingyes):
            print(end='God Says... ')
        ...
        elif any(keyword in var for keyword in topicloving):
            print(end='God Says... ')
        ...
        elif any(keyword in var for keyword in topicschool):
            print(end='God Says... ')
            print(random.choice(g15))

        elif any(keyword in var for keyword in topiccomedy):
            print(end='God Says... ')
            print(random.choice(g16))
        
        elif any(keyword in var for keyword in topicmoney):
            print(end='God Says... ')
